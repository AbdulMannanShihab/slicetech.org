<div class="bg-white">
    <div class="max-w-xl mx-auto pt-10 pb-10">
        ...
        <div class="relative flex flex-col items-center">
            <h1 class="text-5xl font-bold dark:text-gray-200"> Latest <span class="text-blue-500"> Blogs
            </span> </h1>
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="grid lg:grid-cols-2 lg:gap-y-16 gap-10">
            <!-- Card -->
            <a wire:navigate class="group block rounded-xl overflow-hidden focus:outline-none shadow-lg" href="{{route('blog-details')}}">
            ...
            <!-- Card -->
            <a class="group block rounded-xl overflow-hidden focus:outline-non" href="#">
                <div class="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5">
                <div class="shrink-0 relative rounded-xl overflow-hidden w-full sm:w-56 h-44">
    ...
    <!-- End Card Blog -->
    <div class="flex justify-end pt-3 pb-5 md:pt-0 mr-10">
        <a wire:navigate class="py-2.5 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{ route('blogs') }}"> 
            Read More
            <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
        </a>
    </div>
